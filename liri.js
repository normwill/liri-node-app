...
if(argument === "movie-this"){
	...
	request("http://www.omdapi/?=" + movieTitle + "&y=&plot=short&apikey=40e9cece", function(error, response, body){
		if(process.argv[3]){
			console.log(body);
		} else{
			request("http://www.omdapi.com/t=the+prestige+&y=&plot=short&apikey=40e9cece", function(error, response, body){
				console.log(body);
			})
		}
	})
